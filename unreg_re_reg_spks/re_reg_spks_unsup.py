...
from evaluation import eval_per_epoch_per_bucket_contrastive_unsupervised
...
from .train_re_reg_epoch_unsup import train_re_reg_per_epoch_unsup
...
def re_reg_unsup(
    ...
    paths_filenames = create_filenames_re_reg_unsup_results(
        args,
        hparams,
        args.spk_per_bucket,
        unreg_spks,
    ...
    dvec_model_obj = DvecModelDynamicReRegUnsupervised(
        device,
        buckets,
    ...
    model_dvec = DvecGeneralDynamicReRegUnsupervised(
        dvec_model_obj,
        dvec_opt_obj,
        SGD,
        device,
    ...
    dvectors, cont_losses, opt_dvecs, _ = model_dvec.load_model_opt(
        ...
        filenames_dvec_and_dirs["filename_dvec_re_reg"],
    )
    ...
    for epoch in range(start_epoch, start_epoch + args.epoch):
        ...
        td = train_re_reg_per_epoch_unsup(
            hparams,
            args,
            device,
            outputs,
        ...
        val_out = eval_per_epoch_per_bucket_contrastive_unsupervised(
            hparams,
            args,
            device,
            outputs,
