...
from utils import compute_prototypes, pairwise_distances


def compute_opt_bkt_final(
    dvectors,
    bucket_id_chosen,
    round_num,
    number_of_bucket,
    ...
    for bucket_id in range(number_of_bucket):
        ...
        if round_num > 0:
            ...
            if sub_lbs_previous_other:
                ...
                x_cat = torch.cat((x, x_prev_other), dim=0)
                emb_spk = dvectors[bucket_id](x_cat)
