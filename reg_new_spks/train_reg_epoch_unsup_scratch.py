...
from .train_reg_epoch_bkt_unsup_scratch import (
    train_reg_per_round_per_epoch_per_bkt_unsup_scratch,
)


@custom_timer
def train_reg_per_round_per_epoch_unsup_scratch(
    hparams,
    args,
    device,
    outputs,
    ...
    **kwargs_training,
    ...
    for indx, bucket_id in enumerate(buckets):
        ...
        feat_props = train_reg_per_round_per_epoch_per_bkt_unsup_scratch(
            hparams,
            args,
            device,
            outputs,
