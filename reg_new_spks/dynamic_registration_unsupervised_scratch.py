...
from .train_reg_epoch_unsup_scratch import train_reg_per_round_per_epoch_unsup_scratch
...
def dyn_reg_unsup_scratch(
    ...
    filenames_dvec_and_dirs = create_filenames_dvec_unsup_dynamic_scratch(
        buckets,
        args,
        hparams,
        hparams.round_num,
    )
    filenames_and_dirs = create_filenames_dvec_latent_dynamic_scratch(
        args,
        hparams,
        hparams.round_num,
    )
    ...
    paths_filenames = create_filenames_reg_unsupervised_scratch_results(
        args,
        hparams.ma_mode,
        args.max_mem_unsup,
    ...
    for epoch in range(
        ...
        if len(opt_unique_bkt) != 0:
            ...
            td_train = train_reg_per_round_per_epoch_unsup_scratch(
                hparams,
                args,
                device,
                outputs,
