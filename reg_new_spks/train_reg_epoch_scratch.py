...
from .train_reg_epoch_bkt_scratch import train_reg_per_round_per_epoch_per_bkt_scratch


@custom_timer
def train_reg_per_round_per_epoch_scratch(
    hparams,
    args,
    device,
    outputs,
    ...
    **kwargs_training,
    ...
    for indx, bucket_id in enumerate(buckets):
        ...
        feat_props = train_reg_per_round_per_epoch_per_bkt_scratch(
            args,
            device,
            outputs,
            bucket_id,
