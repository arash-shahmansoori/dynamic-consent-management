...
from .train_strategy_new_reg_epoch_bkt_unsup_scratch import (
    train_strategy_new_reg_per_epoch_per_bkt_unsup_scratch,
)
from .train_strategy_new_reg_causal_epoch_bkt_unsup_scratch import (
    train_strategy_new_reg_causal_per_epoch_per_bkt_unsup_scratch,
)
from .train_strategy_sofar_reg_causal_epoch_bkt_unsup_scratch import (
    train_strategy_sofar_reg_causal_per_epoch_per_bkt_unsup_scratch,
)
from .train_strategy_old_reg_epoch_bkt_unsup_scratch import (
    train_strategy_old_reg_per_epoch_per_bkt_unsup_scratch,
)


def train_reg_per_round_per_epoch_per_bkt_unsup_scratch(
    hparams,
    args,
    device,
    outputs,
    ...
    **kwargs_training,
    ...
    if strategy_keys["strategy_1"]:
        ...
        train_strategy = train_strategy_new_reg_per_epoch_per_bkt_unsup_scratch(
            epoch,
            indx_opt_unique_bkt,
        ...
        train_strategy = train_strategy_new_reg_causal_per_epoch_per_bkt_unsup_scratch(
            epoch,
            indx_opt_unique_bkt_sofar,
            spk_selected_strategy_sofar,
            indx_opt_unique_bkt,
        ...
        train_strategy = train_strategy_old_reg_per_epoch_per_bkt_unsup_scratch(
            epoch,
            kwargs_training["early_stop"][bucket_id],
        )
    else:
