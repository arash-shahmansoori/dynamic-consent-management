...
from utils import create_filenames_results_sup_scratch


def load_metrics_sup_scratch(args, agnt_num):
    ...
    paths_filenames = create_filenames_results_sup_scratch(args, agnt_num)
