...
def plot_result_tsne_dyn_reg_sup_unsup(args, hparams):
    ...
    paths_filenames_unsup = create_filenames_tsne_unsup_results(args, hparams)
    ...
    dfXsup[r"dynamic registrations"] = Ysup
    dfXsup.columns = ["dim-1", "dim-2", "dynamic registrations"]

    # dfXunsup = pd.DataFrame(Xunsup)
    # dfXunsup[r"dynamic registrations"] = Yunsup
    # dfXunsup.columns = ["dim-1", "dim-2", "dynamic registrations"]

    makers = {"Old speakers": "1", "New speakers": "+"}
    ...
    #     x="dim-1",
    #     y="dim-2",
    #     hue=dfXunsup["dynamic registrations"],
    #     style="dynamic registrations",
    #     ax=ax2,
    # )
    ...
    # fig.savefig(
    #     f"{result_dir_plot_path}/tsne_eval_dyn_reg_agnt_2.pdf",
    #     format="pdf",
    #     bbox_inches="tight",
    #     dpi=1200,
    # )
