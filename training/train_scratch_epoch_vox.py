...
def train_cls_scratch_vox(args, model, inputs, opt, criterion):
...
def train_scratch_per_epoch_vox(
    args,
    device,
    epoch,
    classifier,
    ...
    **kwargs_training,
    ...
    train_loader = DataLoader(
        ...
        shuffle=False,
        collate_fn=kwargs_training["collateSpkr"],
        drop_last=True,
    )
