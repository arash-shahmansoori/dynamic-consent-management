...
def _download_extract_wavs(root):
...
def _get_flist_custom(file_path):
    f_list = []
...
def _get_paired_flist(veri_test_path):
    f_list = []
...
def _get_file_id(file_path, _ext_audio):
...
class VoxCeleb1IdentificationCustom(VoxCeleb1):
    ...
    def __init__(
        ...
        self._flist = _get_flist_custom(meta_list_path)
...
class VoxCeleb1VerificationCustom(VoxCeleb1):
