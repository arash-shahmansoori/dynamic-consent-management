...
from .eval_new_reg_epoch_bkt_unsup import eval_new_reg_per_round_per_epoch_per_bkt_unsup
from .eval_new_reg_causal_epoch_bkt_unsup import (
    eval_new_reg_causal_per_round_per_epoch_per_bkt_unsup,
)
from .eval_sofar_reg_causal_epoch_bkt_unsup import (
    eval_sofar_reg_causal_per_round_per_epoch_per_bkt_unsup,
)
from .eval_old_epoch_bkt_unsup import eval_old_per_round_per_epoch_per_bkt_unsup


def eval_reg_overall_per_round_per_epoch_per_bkt_unsup(
    args,
    device,
    outputs,
    bucket_id,
    ...
    **kwargs_validation,
    ...
    if strategy_condition["strategy_1"]:
        ...
        eval_reg_per_round_per_epoch_per_bkt = partial(
            eval_new_reg_per_round_per_epoch_per_bkt_unsup,
            indx_opt_unique_bkt,
        ...
        eval_reg_per_round_per_epoch_per_bkt = (
            eval_old_per_round_per_epoch_per_bkt_unsup
        )
