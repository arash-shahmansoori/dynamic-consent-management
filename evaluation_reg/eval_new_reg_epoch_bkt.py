...
def eval_new_reg_per_round_per_epoch_per_bkt(
    indx_opt_unique_bkt,
    indx_selected_id,
    args,
    outputs,
    ...
    **kwargs_validation,
    ...
    spk_val_cat = torch.cat((spk_val, spk_other_val + args.n_speakers), dim=0)
